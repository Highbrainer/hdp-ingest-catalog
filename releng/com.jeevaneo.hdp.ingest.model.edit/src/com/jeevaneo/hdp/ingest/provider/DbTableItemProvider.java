...
/**
 * This is the item provider adapter for a {@link com.jeevaneo.hdp.ingest.DbTable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DbTableItemProvider 
	 ...
	 * @generated
	 */
	public DbTableItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DbTable_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DbTable_name_feature", "_UI_DbTable_type"),
				 IngestPackage.Literals.DB_TABLE__NAME,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DbTable"));
	}
	...
	public String getText(Object object) {
		String label = ((DbTable)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DbTable_type") :
			getString("_UI_DbTable_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DbTable.class)) {
	...
	public ResourceLocator getResourceLocator() {
		return IngestEditPlugin.INSTANCE;
	}
