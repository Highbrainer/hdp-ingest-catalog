...
/**
 * This is the item provider adapter for a {@link com.jeevaneo.hdp.ingest.Database} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DatabaseItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Database_label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Database_label_feature", "_UI_Database_type"),
				 IngestPackage.Literals.DATABASE__LABEL,
				 true,
				 false,
				 false,
	...
	protected void addJdbcUrlPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Database_jdbcUrl_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Database_jdbcUrl_feature", "_UI_Database_type"),
				 IngestPackage.Literals.DATABASE__JDBC_URL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addJdbcUserPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Database_jdbcUser_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Database_jdbcUser_feature", "_UI_Database_type"),
				 IngestPackage.Literals.DATABASE__JDBC_USER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addJdbcPasswordPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Database_jdbcPassword_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Database_jdbcPassword_feature", "_UI_Database_type"),
				 IngestPackage.Literals.DATABASE__JDBC_PASSWORD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addJdbcDriverPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Database_jdbcDriver_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Database_jdbcDriver_feature", "_UI_Database_type"),
				 IngestPackage.Literals.DATABASE__JDBC_DRIVER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(IngestPackage.Literals.DATABASE__SCHEMAS);
		}
	...
	public String getText(Object object) {
		String label = ((Database)object).getLabel();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(IngestPackage.Literals.DATABASE__SCHEMAS,
				 IngestFactory.eINSTANCE.createDbSchema()));
	}
